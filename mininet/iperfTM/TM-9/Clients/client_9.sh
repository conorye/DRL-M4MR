...
iperf3 -c 192.168.0.1 -p 9001 -u -b 24828.61k -t 30 --tos 105 >/dev/null 2>&1 &
sleep 0.4
...
sleep 0.4
iperf3 -c 192.168.0.6 -p 9006 -u -b 5461.62k -t 30 --tos 110 >/dev/null 2>&1 &
sleep 0.4
...
sleep 0.4
iperf3 -c 192.168.0.14 -p 9014 -u -b 8953.49k -t 30 --tos 117 >/dev/null 2>&1 &
sleep 0.4