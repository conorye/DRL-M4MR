...
sleep 0.4
iperf3 -c 192.168.0.6 -p 7006 -u -b 1606.42k -t 30 --tos 84 >/dev/null 2>&1 &
sleep 0.4
iperf3 -c 192.168.0.8 -p 7008 -u -b 2542.05k -t 30 --tos 85 >/dev/null 2>&1 &
sleep 0.4
iperf3 -c 192.168.0.9 -p 7009 -u -b 6383.78k -t 30 --tos 86 >/dev/null 2>&1 &
sleep 0.4
...
sleep 0.4
iperf3 -c 192.168.0.12 -p 7012 -u -b 5605.73k -t 30 --tos 89 >/dev/null 2>&1 &
sleep 0.4
