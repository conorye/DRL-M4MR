...
sleep 0.4
iperf3 -c 192.168.0.5 -p 1005 -u -b 8899.28k -t 30 --tos 4 >/dev/null 2>&1 &
sleep 0.4
...
sleep 0.4
iperf3 -c 192.168.0.13 -p 1013 -u -b 19449.10k -t 30 --tos 12 >/dev/null 2>&1 &
sleep 0.4
iperf3 -c 192.168.0.14 -p 1014 -u -b 9394.39k -t 30 --tos 13 >/dev/null 2>&1 &
sleep 0.4