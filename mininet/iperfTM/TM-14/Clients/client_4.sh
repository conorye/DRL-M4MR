...
sleep 0.4
iperf3 -c 192.168.0.5 -p 4005 -u -b 2222.67k -t 30 --tos 43 >/dev/null 2>&1 &
sleep 0.4
...
sleep 0.4
iperf3 -c 192.168.0.10 -p 4010 -u -b 1033.76k -t 30 --tos 48 >/dev/null 2>&1 &
sleep 0.4
...
sleep 0.4
iperf3 -c 192.168.0.13 -p 4013 -u -b 4857.57k -t 30 --tos 51 >/dev/null 2>&1 &
sleep 0.4
