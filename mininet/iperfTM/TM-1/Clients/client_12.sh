...
sleep 0.4
iperf3 -c 192.168.0.3 -p 12003 -u -b 9402.38k -t 30 --tos 146 >/dev/null 2>&1 &
sleep 0.4
...
sleep 0.4
iperf3 -c 192.168.0.10 -p 12010 -u -b 2890.36k -t 30 --tos 153 >/dev/null 2>&1 &
sleep 0.4
...
sleep 0.4
iperf3 -c 192.168.0.14 -p 12014 -u -b 6560.29k -t 30 --tos 156 >/dev/null 2>&1 &
sleep 0.4