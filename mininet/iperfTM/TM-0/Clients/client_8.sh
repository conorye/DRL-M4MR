...
sleep 0.4
iperf3 -c 192.168.0.7 -p 8007 -u -b 2047.59k -t 30 --tos 98 >/dev/null 2>&1 &
sleep 0.4
...
sleep 0.4
iperf3 -c 192.168.0.12 -p 8012 -u -b 5606.95k -t 30 --tos 102 >/dev/null 2>&1 &
sleep 0.4
iperf3 -c 192.168.0.13 -p 8013 -u -b 5453.23k -t 30 --tos 103 >/dev/null 2>&1 &
sleep 0.4
iperf3 -c 192.168.0.14 -p 8014 -u -b 2634.04k -t 30 --tos 104 >/dev/null 2>&1 &
sleep 0.4