...
sleep 0.4
iperf3 -c 192.168.0.2 -p 3002 -u -b 11683.36k -t 30 --tos 28 >/dev/null 2>&1 &
sleep 0.4
iperf3 -c 192.168.0.4 -p 3004 -u -b 3636.35k -t 30 --tos 29 >/dev/null 2>&1 &
sleep 0.4
iperf3 -c 192.168.0.5 -p 3005 -u -b 4506.96k -t 30 --tos 30 >/dev/null 2>&1 &
sleep 0.4
...
sleep 0.4
iperf3 -c 192.168.0.10 -p 3010 -u -b 2096.17k -t 30 --tos 35 >/dev/null 2>&1 &
sleep 0.4
iperf3 -c 192.168.0.11 -p 3011 -u -b 1884.65k -t 30 --tos 36 >/dev/null 2>&1 &
sleep 0.4
