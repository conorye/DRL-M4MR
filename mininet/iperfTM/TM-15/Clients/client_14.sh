...
sleep 0.4
iperf3 -c 192.168.0.7 -p 14007 -u -b 2496.22k -t 30 --tos 176 >/dev/null 2>&1 &
sleep 0.4
...
sleep 0.4
iperf3 -c 192.168.0.10 -p 14010 -u -b 1414.79k -t 30 --tos 179 >/dev/null 2>&1 &
sleep 0.4
iperf3 -c 192.168.0.11 -p 14011 -u -b 1272.02k -t 30 --tos 180 >/dev/null 2>&1 &
sleep 0.4
