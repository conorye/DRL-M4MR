...
sleep 0.4
iperf3 -c 192.168.0.6 -p 1006 -u -b 4914.59k -t 30 --tos 5 >/dev/null 2>&1 &
sleep 0.4
iperf3 -c 192.168.0.7 -p 1007 -u -b 0.00k -t 30 --tos 6 >/dev/null 2>&1 &
sleep 0.4
iperf3 -c 192.168.0.8 -p 1008 -u -b 7777.01k -t 30 --tos 7 >/dev/null 2>&1 &
sleep 0.4
...
sleep 0.4
iperf3 -c 192.168.0.12 -p 1012 -u -b 17149.87k -t 30 --tos 11 >/dev/null 2>&1 &
sleep 0.4
