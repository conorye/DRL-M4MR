...
sleep 0.4
iperf3 -c 192.168.0.9 -p 6009 -u -b 5043.78k -t 30 --tos 73 >/dev/null 2>&1 &
sleep 0.4
iperf3 -c 192.168.0.10 -p 6010 -u -b 916.72k -t 30 --tos 74 >/dev/null 2>&1 &
sleep 0.4
iperf3 -c 192.168.0.11 -p 6011 -u -b 824.22k -t 30 --tos 75 >/dev/null 2>&1 &
sleep 0.4
