...
sleep 0.4
iperf3 -c 192.168.0.2 -p 11002 -u -b 3318.04k -t 30 --tos 132 >/dev/null 2>&1 &
sleep 0.4
...
sleep 0.4
iperf3 -c 192.168.0.12 -p 11012 -u -b 2876.17k -t 30 --tos 141 >/dev/null 2>&1 &
sleep 0.4
iperf3 -c 192.168.0.13 -p 11013 -u -b 2797.32k -t 30 --tos 142 >/dev/null 2>&1 &
sleep 0.4
iperf3 -c 192.168.0.14 -p 11014 -u -b 1351.17k -t 30 --tos 143 >/dev/null 2>&1 &
sleep 0.4