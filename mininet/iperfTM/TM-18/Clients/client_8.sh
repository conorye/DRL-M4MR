...
sleep 0.4
iperf3 -c 192.168.0.2 -p 8002 -u -b 8085.44k -t 30 --tos 93 >/dev/null 2>&1 &
sleep 0.4
iperf3 -c 192.168.0.3 -p 8003 -u -b 4718.98k -t 30 --tos 94 >/dev/null 2>&1 &
sleep 0.4
iperf3 -c 192.168.0.4 -p 8004 -u -b 2516.52k -t 30 --tos 95 >/dev/null 2>&1 &
sleep 0.4
...
sleep 0.4
iperf3 -c 192.168.0.9 -p 8009 -u -b 7981.45k -t 30 --tos 99 >/dev/null 2>&1 &
sleep 0.4
iperf3 -c 192.168.0.10 -p 8010 -u -b 1450.65k -t 30 --tos 100 >/dev/null 2>&1 &
sleep 0.4
